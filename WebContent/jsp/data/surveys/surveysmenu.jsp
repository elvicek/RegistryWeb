...
<tr><td><a href="<s:url action="allsurysveview_action" namespace="/"/>">View All Surveys</a></td><td>List Of All Survey requests Entered in Database</td></tr>
<tr><td><a href="<s:url action="createsurveys_action" namespace="/"/>">Create New Survey</a></td><td>Add surveys to Registry</td></tr>
<tr><td><a href="<s:url action="mysurveysview_action" namespace="/"/>">Survey Jobs</a></td><td>List Of All Jobs Allocate To Me</td></tr>
