...
<s:form action = "clientsave_action" method="POST">
	...
	<td colspan="2"><s:textfield label="Client Name" name="client.clientName" size="30" required="true"/></td>
	<td colspan="3"><s:textfield label="Client Description" name="client.description" size="30" required="true"/></td>
	<td colspan="2"><s:textfield label="Address Line 1" name="clientAddress.addressline1" size="30" required="true"/></td>
	<td colspan="2"><s:textfield label="Address Line 2" name="clientAddress.addressline2" size="30" required="true"/></td>
	<td colspan="2"><s:textfield label="Address Line 3" name="clientAddress.addressline3" size="30"/></td>
	<td colspan="3"><hr/></td>
	<td colspan="3">&nbsp;</td>
