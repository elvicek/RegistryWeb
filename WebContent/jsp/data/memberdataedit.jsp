...
<div class="Tabview" id="Tabview" style="background: #fff;">
    <div class="Tabs" style="width: 350px;"> <a>Member</a> <a>Groups</a> </div>
	...
	<td colspan="2"><s:select name="member.maritalStatus" label="Marital Status" headerKey="%{#session.Member.maritalStatus}" headerValue="%{#session.Member.maritalStatus}" list="maritalStatus" listKey="description" listValue="description" required="true" value="%{#session.Member.maritalStatus}"/></td>
	...
	<td colspan="2"><s:checkbox name="member.newMember" fieldValue="true" label="New Member?" value="%{#session.Member.newMember}"/></td>
